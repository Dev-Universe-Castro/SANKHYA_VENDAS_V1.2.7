...
export function EscolherPrecoTabelaModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton={false} className="max-w-[600px] w-[95vw] sm:w-full p-0 border-0 bg-slate-50/50 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
