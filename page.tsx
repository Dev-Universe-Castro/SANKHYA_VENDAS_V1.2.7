  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#121212] flex flex-col overflow-x-hidden">
      ...
      <main className="flex-1 mt-20">
        {/* HERO SECTION */}
        <section className="relative pt-20 pb-24 lg:pt-32 lg:pb-32 overflow-hidden border-b border-gray-50">
          <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-[#76BA1B]/10 blur-[80px] pointer-events-none" />
          <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-[30rem] h-[30rem] rounded-full bg-[#1E5128]/5 blur-[100px] pointer-events-none" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                <motion.div variants={fadeInUp} className="inline-flex items-center px-4 py-2 rounded-full bg-[#76BA1B]/10 border border-[#76BA1B]/20 text-sm font-medium text-[#1E5128] mb-8">
                  <span className="flex h-2 w-2 rounded-full bg-[#76BA1B] mr-2"></span>
                  Inteligência Artificial para Vendas B2B
                </motion.div>

                <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-black font-montserrat tracking-tight text-[#121212] mb-6 leading-tight">
                  Força de Vendas <br className="hidden md:block" />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E5128] to-[#76BA1B]">Integrada e Inteligente</span>
                </motion.h1>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-[#76BA1B] font-bold tracking-wider uppercase text-sm mb-3">Descubra o Predict</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Link href="/planos" className="group">
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all h-full flex flex-col items-center text-center">
                  ...
                  <h4 className="text-xl font-bold mb-3 group-hover:text-[#76BA1B] transition-colors">Planos</h4>
                  <p className="text-gray-500 text-sm mb-4">Conheça os planos desenhados pro tamanho do seu faturamento.</p>
                  <span className="text-[#1E5128] font-bold text-sm mt-auto flex items-center group-hover:translate-x-1 transition-transform">Ler mais <ArrowRight className="ml-1 w-4 h-4" /></span>
                </div>
              </Link>
            </div>
