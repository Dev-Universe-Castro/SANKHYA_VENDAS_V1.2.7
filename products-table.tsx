...
import { Search, ChevronLeft, ChevronRight, Package, Eye, ChevronDown, ChevronUp, WifiOff, X, RefreshCw } from "lucide-react"
  ...
  return (
    <div className="flex flex-col h-full bg-transparent overflow-hidden scrollbar-hide">
      ...
      <div className="md:hidden px-4 py-4 bg-transparent border-b border-black/5">
        ...
        <p className="text-sm text-[#1E5128]/70 mt-1">Catálogo de produtos e estoque</p>
      </div>
                    ...
                    <Card key={product._id || product.CODPROD} className="group hover:shadow-xl transition-all duration-300 overflow-hidden rounded-2xl border-[#F2F2F2]">
                      ...
                      <CardContent className="p-3 space-y-2 relative">
                        ...
                        <Button
                          ...
                          className="w-full h-8 text-[11px] font-bold bg-[#76BA1B] hover:bg-[#1E5128] text-white rounded-xl shadow-md transition-all mt-2"
                        >
                    ...
                    >
                      <div className="flex gap-3">
                        ...
                        <Button
                          size="icon"
                          onClick={() => abrirModal(product)}
                          className="h-10 w-10 rounded-full bg-[#76BA1B] hover:bg-[#1E5128] text-white shadow-md transition-all flex-shrink-0 self-center"
                        >
