  ...
  return (
    <div className="min-h-screen w-full flex bg-white flex-col lg:flex-row font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1E5128] flex-col p-12 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#76BA1B]/20 to-transparent z-0 pointer-events-none" />
        <div className="absolute -bottom-[20%] -right-[20%] w-[70%] h-[70%] rounded-full bg-[#76BA1B]/20 blur-[120px] z-0 pointer-events-none" />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-white">
        <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] sm:border sm:border-gray-100 flex flex-col justify-center min-h-[500px]">
          ...
          <div className="mt-8 text-center text-sm font-medium">
            ...
            <Link href="/register" className="text-[#2ECC71] hover:text-[#27ae60] transition-colors">
              Solicite seu acesso
            </Link>
          </div>
        </div>
