                ...
                <div key={index} className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm hover:border-[#76BA1B]/30 hover:shadow-md transition-all group">
                  <div className="flex flex-col gap-3">
                    <div className="flex justify-between items-start gap-4">
                      {/* Imagem do Produto */}
                      <div className="w-16 h-16 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            if (parent) {
                              parent.innerHTML = `<div class="text-xl text-slate-300 font-bold">${item.DESCRPROD?.charAt(0) || 'P'}</div>`
                            }
                          }}
                        />
                      </div>
