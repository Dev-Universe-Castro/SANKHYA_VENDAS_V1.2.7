    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-[#121212] flex flex-col overflow-x-hidden">
            ...
            <main className="flex-1 mt-20">
                ...
                <section className="bg-[#1E5128] text-white py-24 relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-3xl mx-auto">
                            <motion.div variants={fadeInUp} className="inline-flex items-center px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-sm font-semibold text-[#76BA1B] mb-6">
                                <span className="mr-2">⚙️</span> Ecossistema Predict
                            </motion.div>
                            ...
                            <div className="lg:w-1/2">
                                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeInUp}>
                                    ...
                                    <p className="text-gray-600 text-lg leading-relaxed mb-6">
                                        A falta de sinal no interior ou em galpões industriais nunca mais será desculpa para perder vendas. A arquitetura Local-First do Predict armazena o banco de dados inteiro no banco de dados local do dispositivo.
                                    </p>
                        ...
                        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                            <div className="lg:w-1/2">
                                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeInUp}>
                                    ...
                                    <p className="text-gray-600 text-lg leading-relaxed mb-6">
                                        Apresente seus produtos de forma profissional. O Predict suporta múltiplas fotos por produto, descrições ricas, categorias, grades (cor/tamanho) e até anexos em PDF (fichas técnicas).
                                    </p>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center max-w-3xl mx-auto mb-20">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed">
                                Pare de perguntar "Como está sua carteira de clientes?". O Predict estrutura as visitas e exibe a saúde financeira da carteira em um dashboard intuitivo, organizando a rotina do representante.
                            </p>
                        </div>
