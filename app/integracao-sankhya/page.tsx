    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-900 flex flex-col overflow-x-hidden">
            ...
            <main className="flex-1 mt-20">
                ...
                {/* HERO ARQUITETURA */}
                <section className="bg-gray-900 text-white py-32 relative overflow-hidden border-b border-gray-800">
                            ...
                            <div className="lg:w-3/5">
                                <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
                                    ...
                                    <p className="text-xl text-gray-400 leading-relaxed mb-10 max-w-2xl font-light">
                                        O aplicativo Predict foi desenhado por arquitetos especialistas no banco de dados do Sankhya. Excluímos camadas desnecessárias de middleware para prover sincronismo nativo bidirecional ("Sync Delta") de altíssima fidelidade.
                                    </p>
                                ...
                                >
                                    <div className="flex flex-col items-center gap-6">
                                        ...
                                        <div className="w-full bg-[#1E5128]/20 border-2 border-[#1E5128] py-4 px-6 rounded-xl flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <span className="font-bold font-mono text-xl text-[#76BA1B]">Predict SQLite</span> <Smartphone className="text-[#76BA1B]" />
                                            </div>
                                        </div>
                                    </div>
                                </motion.div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed">
                                Nós não 'mapeamos nomes'. O Predict reproduz integralmente a lógica de tabelas do Sankhya para que a sua TI não precise fazer nenhum "de-para". Veja o espelho primário de entidades que sincronizamos:
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            <div className="lg:w-1/2">
                                ...
                                <p className="text-white/80 text-lg leading-relaxed mb-8">
                                    Por isso o Predict NÃO DÁ UM "DOWNLOAD" em todo o banco novamente a cada clique. Nossa engenharia extrai o "Delta" (Apenas aquilo que mudou no servidor desde a última consulta, os IDs modificados por timestamp) empacotando numa compressão severa de JSON GZIP.
                                </p>
