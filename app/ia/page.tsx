                                        ...
                                        <div className="p-6 space-y-6 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]">
                                            ...
                                            <div className="flex gap-4 items-start justify-end">
                                                <div className="bg-[#1E5128]/40 border border-[#76BA1B]/20 p-4 rounded-2xl rounded-tr-sm text-sm text-gray-300 max-w-[80%]">
                                                    Mostre as vendas de Cerveja Artesanal nos últimos 6 meses.
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex gap-4 items-start">
                                                ...
                                                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl rounded-tl-sm w-full">
                                                    <p className="text-sm text-gray-300 mb-4">Aqui está o cruzamento focado em "Cerveja Artesanal" semestral. <strong className="text-white">Notei uma queda de 12% atípica em Mai/Jun</strong> nos clientes do Cluster B.</p>
                            ...
                            <div className="lg:w-1/2 order-1 lg:order-2">
                                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
                                    ...
                                    <p className="text-gray-400 text-lg leading-relaxed mb-8">
                                        Chega de esperar a TI criar um dashboard ou exportar planilhas do banco. Os gestores usam a Predict Sales AI para consultar o banco de dados em linguagem natural.
                                    </p>
