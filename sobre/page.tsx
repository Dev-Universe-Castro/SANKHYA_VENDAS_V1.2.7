                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                        <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="max-w-4xl mx-auto">
                            ...
                            <p className="text-xl text-gray-600 leading-relaxed mb-12">
                                O Predict não foi idealizado dentro de um escritório fechado. Ele nasceu das dores reais de representantes comerciais que sofriam com planilhas lentas, erros de estoque e clientes insatisfeitos.
                            </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                            ...
                            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="bg-[#1E5128] p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
                                ...
                                <div className="text-[#76BA1B] font-bold mb-6 flex items-center uppercase tracking-widest text-sm">
                                    <span className="w-8 h-[2px] bg-[#76BA1B] mr-3"></span> O Padrão Predict
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-gray-600 leading-relaxed">Não acreditamos em sistemas paralelos. O ERP da empresa é a fonte da verdade de crédito e impostos. O ecossistema Predict foi construído sendo 100% amarrado na essência do Sankhya de forma bi-direcional.</p>
                            </div>
                            <div className="flex flex-col items-center text-center">
                                <div className="h-20 w-20 rounded-full bg-[#1E5128]/10 text-[#1E5128] flex items-center justify-center mb-6">
