                        ...
                        <TableRow key={pedido.ID} className="hover:bg-gray-50/50 cursor-pointer" onClick={() => abrirPedido(pedido)}>
                          ...
                          <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-1">
                              <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); abrirPedido(pedido); }} className="h-8 w-8 p-0" title="Visualizar"><Eye className="w-4 h-4 text-gray-500" /></Button>
                              <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); duplicarPedido(pedido); }} className="h-8 w-8 p-0" title="Duplicar"><Copy className="w-4 h-4 text-gray-500" /></Button>
                              <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); exportarPedidoPDF(pedido); }} className="h-8 w-8 p-0" title="Exportar PDF"><FileText className="w-4 h-4 text-blue-500" /></Button>
                            </div>
                          </TableCell>
                        </TableRow>
                      ))
